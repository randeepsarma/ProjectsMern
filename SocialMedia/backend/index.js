...
export const pusher = new Pusher({
  appId: "1610867",
  key: "b4714209ae2fb62c0dd3",
  secret: "6ff03bac3952be997c28",
  cluster: "ap2",
  useTLS: true
});
...
const corsOptions ={
  origin:/* 'https://projects-mern.vercel.app' ||  */'http://localhost:3000', 
...
db.once('open', () => {
  ...
  changeStream.on('change', (change) => {
    ...
    if (change.operationType === 'insert') {
      ...
      pusher.trigger(`messages-${newMessage.receiver}`, 'inserted', newMessage);
