  ...
  return (
    <>
      <div className='flex flex-col  h-screen w-full justify-center items-center' >
        <form className=" flex justify-center items-center flex-col  box-border  h-[85vh] w-[55vw] rounded-2xl shadow-[2px_2px_20px_2px_rgba(0,0,0,0.3)] mt-16" onSubmit={handleSubmit} ref={formRef}>
          <CssTextField
          ...
          <div className="w-[40vw] h-[8vh] shadow-[5px_5px_5px_3px_rgba(0,0,0,0.3)] mt-8">
            <input type="submit" value="Register" className="bg-[#03fcdf] cursor-pointer  box-border w-full h-full rounded-[0.35rem] text-[1.5rem] text-[#2d2d2d] " />
          </div>
          <div className="mt-[1.5rem]"><a href="/" className=" hover:underline hover:text-[#0e2684]">Already have an account?Click Here</a></div>
