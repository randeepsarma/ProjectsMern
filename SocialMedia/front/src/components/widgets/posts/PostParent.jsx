...
import WidgetParent from '../WidgetParent'
  ...
  return (
    <Fragment>
      <div className='flex flex-col box-border w-[100%] items-center'>
        ...
        {
          details.map(({ firstname, lastname, userId, imageUrl, postUrl, location, description, _id, likes }) => (
            <PostWidget key={_id} firstname={firstname} lastname={lastname} userId={userId} imageUrl={imageUrl} postUrl={postUrl} location={location} description={description} _id={_id} handleDeletePost={handleDeletePost} handleFriendRequest={handleRequest} likes={likes} />
          ))
        }
